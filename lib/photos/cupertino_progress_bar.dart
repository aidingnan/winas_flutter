...
class _ChewieProgressColors {
  _ChewieProgressColors({
    Color playedColor: const Color.fromARGB(120, 255, 255, 255),
    Color bufferedColor: const Color.fromARGB(60, 255, 255, 255),
    Color handleColor: const Color.fromARGB(255, 255, 255, 255),
...
/// modify from 'package:chewie/src/cupertino_progress_bar.dart'
class CupertinoVideoProgressBar extends StatefulWidget {
  ...
  final _ChewieProgressColors colors = _ChewieProgressColors();
